...
import DropdownLanguage from "./dropdownLanguage/Dropdown.tsx";
...
function Header() {
  ...
  return (
    <div ref={searchRef} className={classNames(style["section-nav__header"])}>
      ...
      <div className={classNames(style["section-top"])}>
        <p className={classNames(style["section-top__paragraph"])}>
          {t("summerSale")}
          <a className={classNames(style["section-top__link"])} href="/">
            ShopNow
          </a>
        </p>
       <div className={classNames(style["section-top__dropdown"])}>
       <DropdownLanguage />
       </div>
      </div>
      <section className={classNames(style["section-nav"])}>
        ...
        <ul className={classNames(style["section-nav__menu"])}>
          <li className={classNames(style["section-nav__menu-item"])}>
            <Link
              className={classNames(style["section-nav__menu-item-link"], animateLink)}
              href="/"
            >
              {" "}
              Home
        ...
        <section className={classNames(style["section-nav__helpers"])}>
          ...
          >
            <IoMdHeartEmpty
              className={classNames(style["section-nav__helpers-desire-icon"],"text-black")}
            />
          </Link>
          <Link
          ...
          >
            <IoCartOutline
              className={classNames(style["section-nav__helpers-cart-icon"],"text-black")}
            />
          </Link>
          <button onClick={HandleMenu}>
            {" "}
            <SlMenu
              className={classNames(style["section-nav__helpers-menu-icon"],"text-black")}
            />
          </button>
        </section>
        {showSearch && (
